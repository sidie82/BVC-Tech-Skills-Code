...
-- VotingStationName Table --

ALTER TABLE VotingStationName
ADD CONSTRAINT VotingStationIDs CHECK (PK_VotingStationIDs >= 0);

-- VotingStationType Table --

ALTER TABLE VotingStationType
ADD CONSTRAINT VotingStationTypeIDs CHECK (PK_VotingStationTypeIDs >= 0);